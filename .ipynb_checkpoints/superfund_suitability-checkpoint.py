...
class SDSS_GUI:
    ...
    def runAHP(self, inputs):
        ...
        NATURAL_AREAS_RADIUS = int(inputs.get('Natural Areas Radius (km)')) * 1000
        SCHOOL_RADIUS = int(inputs.get('School Radius (km)')) * 1000
        POP_RADIUS = int(inputs.get('Population Radius (km)')) * 1000
